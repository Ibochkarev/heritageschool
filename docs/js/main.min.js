...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/swiper.esm.js\");\n/* harmony import */ var _node_modules_aos_dist_aos__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../node_modules/aos/dist/aos */ \"./node_modules/aos/dist/aos.js\");\n/* harmony import */ var _node_modules_aos_dist_aos__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_aos_dist_aos__WEBPACK_IMPORTED_MODULE_1__);\n\nswiper__WEBPACK_IMPORTED_MODULE_0__[\"Swiper\"].use([swiper__WEBPACK_IMPORTED_MODULE_0__[\"Thumbs\"], swiper__WEBPACK_IMPORTED_MODULE_0__[\"Navigation\"], swiper__WEBPACK_IMPORTED_MODULE_0__[\"Pagination\"], swiper__WEBPACK_IMPORTED_MODULE_0__[\"Mousewheel\"]]); // import fullpage from \"fullpage.js\"\n\n // const fullPageInstance = new fullpage(\"#fullpage\", {\n//     navigation: true,\n//     autoScrolling: true,\n//     scrollingSpeed: 1200,\n//     responsiveWidth: 768,\n//     onLeave: function () {\n//         jQuery(\".section [data-aos]\").removeClass(\"aos-animate\")\n//     },\n//     onSlideLeave: function () {\n//         jQuery(\".slide [data-aos]\").removeClass(\"aos-animate\")\n//     },\n//     afterSlideLoad: function () {\n//         jQuery(\".slide.active [data-aos]\").addClass(\"aos-animate\")\n//     },\n//     afterLoad: function () {\n//         jQuery(\".section.active [data-aos]\").addClass(\"aos-animate\")\n//     },\n// })\n// //methods\n// fullpage_api.setAllowScrolling(true)\n\n_node_modules_aos_dist_aos__WEBPACK_IMPORTED_MODULE_1___default.a.init({\n  duration: 700,\n  easing: \"ease-out-quad\",\n  once: !0,\n  startEvent: \"load\",\n  disable: window.innerWidth < 768\n});\ndocument.addEventListener(\"DOMContentLoaded\", function () {\n  var homeSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"Swiper\"](\".home-slider .swiper-container\", {\n    loop: false,\n    speed: 2400,\n    navigation: {\n      nextEl: \".swiper-button-next\",\n      prevEl: \".swiper-button-prev\"\n    } // pagination: {\n    //     el: `.swiper-pagination-main`,\n    //     clickable: true,\n    // },\n    // on: {\n    //     afterInit: function () {\n    //         let totalNumber = this.pagination.bullets.length\n    //         this.el.querySelector(\".swiper-pagination-total\").innerText =\n    //             totalNumber < 10 ? `0${totalNumber}` : totalNumber\n    //         let currentNumber = Number(this.activeIndex) + 1\n    //         this.el.querySelector(\".swiper-pagination-num\").innerText =\n    //             currentNumber < 10 ? `0${currentNumber}` : currentNumber\n    //     },\n    //     activeIndexChange: function () {\n    //         let currentNumber = Number(this.activeIndex) + 1\n    //         this.el.querySelector(\".swiper-pagination-num\").innerText =\n    //             currentNumber < 10 ? `0${currentNumber}` : currentNumber\n    //     },\n    // },\n\n  });\n  var teamSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"Swiper\"](\".team-slider\", {\n    slidesPerView: 2,\n    slidesPerColumn: 2,\n    spaceBetween: 30,\n    pagination: {\n      el: \".swiper-pagination-team\",\n      clickable: true\n    },\n    slidesPerColumnFill: \"row\",\n    on: {\n      afterInit: function afterInit() {\n        var totalNumber = this.pagination.bullets.length;\n        var currentNumber = Number(this.activeIndex) + 1;\n        this.el.querySelector(\".swiper-pagination-total\").innerText = totalNumber < 10 ? \"0\".concat(totalNumber) : totalNumber;\n        this.el.querySelector(\".swiper-pagination-num\").innerText = currentNumber < 10 ? \"0\".concat(currentNumber) : currentNumber;\n      },\n      activeIndexChange: function activeIndexChange() {\n        var currentNumber = Number(this.activeIndex) + 1;\n        this.el.querySelector(\".swiper-pagination-num\").innerText = currentNumber < 10 ? \"0\".concat(currentNumber) : currentNumber;\n      }\n    },\n    breakpoints: {\n      640: {\n        slidesPerView: 2\n      },\n      992: {\n        slidesPerView: 2\n      },\n      1024: {\n        slidesPerView: 4\n      }\n    }\n  });\n  var teachersNav = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"Swiper\"]('.teachersNav', {\n    spaceBetween: 0,\n    slidesPerView: 1,\n    centeredSlides: true,\n    loop: true,\n    freeMode: true,\n    navigation: {\n      nextEl: \".swiper-button-next\",\n      prevEl: \".swiper-button-prev\"\n    },\n    breakpoints: {\n      // when window width is >= 992px\n      660: {\n        slidesPerView: 3,\n        spaceBetween: 0\n      }\n    }\n  });\n  var teachersList = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"Swiper\"](\".teachersList\", {\n    spaceBetween: 10,\n    loop: true,\n    autoHeight: true,\n    thumbs: {\n      swiper: teachersNav\n    }\n  });\n  var feedbackSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"Swiper\"](\".feedback-slider\", {\n    // slidesPerView: 2,\n    loop: true,\n    spaceBetween: 30,\n    // centeredSlides: true,\n    pagination: {\n      el: \".swiper-pagination-feedback\",\n      clickable: true\n    },\n    slidesPerColumnFill: \"row\",\n    on: {\n      afterInit: function afterInit() {\n        var totalNumber = this.pagination.bullets.length;\n        var currentNumber = Number(this.activeIndex) + 1;\n        this.el.querySelector(\".swiper-pagination-total\").innerText = totalNumber < 10 ? \"0\".concat(totalNumber) : totalNumber;\n        this.el.querySelector(\".swiper-pagination-num\").innerText = currentNumber < 10 ? \"0\".concat(currentNumber) : currentNumber;\n      },\n      activeIndexChange: function activeIndexChange() {\n        var currentNumber = Number(this.activeIndex) + 1;\n        this.el.querySelector(\".swiper-pagination-num\").innerText = currentNumber < 10 ? \"0\".concat(currentNumber) : currentNumber;\n      }\n    },\n    breakpoints: {\n      640: {\n        slidesPerView: 2,\n        loop: true,\n        spaceBetween: 30,\n        centeredSlides: true\n      }\n    }\n  });\n  var gallerySlider = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"Swiper\"](\".gallery-slider\", {\n    slidesPerView: 2,\n    // loop: true,\n    spaceBetween: 30,\n    centeredSlides: true,\n    pagination: {\n      el: \".swiper-pagination-gallery\",\n      clickable: true\n    },\n    slidesPerColumnFill: \"row\",\n    on: {\n      afterInit: function afterInit() {\n        var totalNumber = this.pagination.bullets.length;\n        var currentNumber = Number(this.activeIndex) + 1;\n        this.el.querySelector(\".swiper-pagination-total\").innerText = totalNumber < 10 ? \"0\".concat(totalNumber) : totalNumber;\n        this.el.querySelector(\".swiper-pagination-num\").innerText = currentNumber < 10 ? \"0\".concat(currentNumber) : currentNumber;\n      },\n      activeIndexChange: function activeIndexChange() {\n        var currentNumber = Number(this.activeIndex) + 1;\n        this.el.querySelector(\".swiper-pagination-num\").innerText = currentNumber < 10 ? \"0\".concat(currentNumber) : currentNumber;\n      }\n    },\n    breakpoints: {\n      640: {\n        spaceBetween: 40\n      },\n      768: {\n        spaceBetween: 50\n      },\n      992: {\n        spaceBetween: 50\n      },\n      1024: {\n        spaceBetween: 120\n      }\n    }\n  });\n  var usefulSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"Swiper\"](\".useful-slider\", {\n    slidesPerView: 2,\n    loop: true,\n    spaceBetween: 10,\n    centeredSlides: true,\n    pagination: {\n      el: \".swiper-pagination-useful\",\n      clickable: true\n    },\n    slidesPerColumnFill: \"row\"\n  }); // Карточка кампуса\n\n  var campusBtn = document.querySelectorAll(\".camspus-item__btn\");\n  campusBtn.forEach(function (el) {\n    el.addEventListener(\"click\", toggleCampus);\n  });\n\n  function toggleCampus(e) {\n    e.preventDefault();\n    var toggleTarget = e.target.classList.contains(\"camspus-item\") ? e.target.parentNode : e.target.classList.contains(\"camspus-item\") ? e.target : e.target.closest(\".camspus-item\");\n\n    if (toggleTarget.classList.contains(\"is-active\")) {\n      toggleTarget.classList.remove(\"is-active\");\n    } else {\n      toggleTarget.classList.add(\"is-active\");\n    }\n  } // Открытие по кнопке мобильного меню\n\n\n  var mobileMenu = document.querySelector(\".mobile-menu\");\n  var menuBtn = document.querySelector(\".header__mobile-btn\");\n  var menuBtnHamburger = document.querySelector(\".header__mobile-btn .is_open\");\n  var menuBtnClose = document.querySelector(\".mobile-menu__close\");\n  var overlay = document.querySelector(\".overlay\");\n  menuBtn.addEventListener(\"click\", toggleMenu);\n  menuBtnClose.addEventListener(\"click\", closeMobileMenu);\n\n  function toggleMenu() {\n    if (mobileMenu.classList.contains(\"_is-active\")) {\n      mobileMenu.classList.remove(\"_is-active\");\n      menuBtnHamburger.style.display = \"block\";\n      overlay.classList.remove(\"_is-open\");\n    } else {\n      mobileMenu.classList.add(\"_is-active\");\n      overlay.classList.add(\"_is-open\");\n      menuBtnHamburger.style.display = \"none\";\n    }\n  }\n\n  function closeMobileMenu() {\n    mobileMenu.classList.remove(\"_is-active\");\n    overlay.classList.remove(\"_is-open\");\n  } // Открытие под меню\n\n\n  var mobileLevelItem = document.querySelectorAll(\".mobile-menu__sub-item, .is-sub .mobile-menu__link\");\n  mobileLevelItem.forEach(function (el) {\n    el.addEventListener(\"click\", toggleLevelMenu);\n  });\n\n  function toggleLevelMenu(e) {\n    e.preventDefault();\n    var toggleTarget = e.target.classList.contains(\"mobile-menu__link\") ? e.target.parentNode : e.target.classList.contains(\"mobile-menu__sub-item\") ? e.target : e.target.closest(\".mobile-menu__sub-item\");\n\n    if (toggleTarget.classList.contains(\"is-open\")) {\n      toggleTarget.classList.remove(\"is-open\");\n    } else {\n      toggleTarget.classList.add(\"is-open\");\n    }\n  }\n\n  var scrollToTopBtn = document.querySelector(\".scroll-top__btn\");\n  scrollToTopBtn.addEventListener(\"click\", scrollToTop);\n\n  function scrollToTop() {\n    window.scrollTo({\n      top: 0,\n      behavior: \"smooth\"\n    });\n  }\n});\n\n//# sourceURL=webpack:///./src/js/main.js?");
