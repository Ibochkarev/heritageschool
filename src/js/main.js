...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const mobileMenu = document.querySelector(".mobile-menu"),
        ...
        menuBtnHamburger = document.querySelector(
            ".header__mobile-btn .is_open"
        ),
        menuBtnClose = document.querySelector(".header__mobile-btn .is_close")
    ...
    // Вызов формы поиска
    const BtnSearchClose = document.querySelector(
            ".search-overlay__close-icon"
        ),
        BtnSearchOpen = document.querySelector(".header__search"),
        searchForm = document.querySelector(".search-overlay")
